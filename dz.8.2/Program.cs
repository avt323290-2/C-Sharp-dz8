...
// Подсчет суммы элементов в строках и показ номера строки, где сумма наименьшая
...
// Функция, которая выводит на консоль двумерный массив
...
// Функция, которая заполняет массив рандомными числами [1,9]
